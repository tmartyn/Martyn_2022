...
############## 45.90 - DF and merging #############
Sorted.45.90<-Stepwat.Sorted[which(Stepwat.Sorted$Period=="d90yrs" & Stepwat.Sorted$RCP=="RCP45"),]
#Sorted.45.90$Bmass.median<-(Sorted.45.90$Bmass.med1+Sorted.45.90$Bmass.med2)/2

##### merge into larger groups
PCG.min.45.90<-Sorted.45.90$Bmass.min[which(Sorted.45.90$RGroup=="p.cool.grass")]
PWG.min.45.90<-Sorted.45.90$Bmass.min[which(Sorted.45.90$RGroup=="p.warm.grass")]
# PG.min.45.90<-PCG.min.45.90+PWG.min.45.90
# 
PCG.max.45.90<-Sorted.45.90$Bmass.max[which(Sorted.45.90$RGroup=="p.cool.grass")]
PWG.max.45.90<-Sorted.45.90$Bmass.max[which(Sorted.45.90$RGroup=="p.warm.grass")]
# PG.max.45.90<-PCG.max.45.90+PWG.max.45.90
# 
PCG.mean.45.90<-Sorted.45.90$Bmass.mean[which(Sorted.45.90$RGroup=="p.cool.grass")]
PWG.mean.45.90<-Sorted.45.90$Bmass.mean[which(Sorted.45.90$RGroup=="p.warm.grass")]
# PG.median.45.90<-PCG.median.45.90+PWG.median.45.90

##### perennial forbs
PCF.min.45.90<-Sorted.45.90$Bmass.min[which(Sorted.45.90$RGroup=="p.cool.forb")]
PWF.min.45.90<-Sorted.45.90$Bmass.min[which(Sorted.45.90$RGroup=="p.warm.forb")]
PF.min.45.90<-PCF.min.45.90+PWF.min.45.90

PCF.max.45.90<-Sorted.45.90$Bmass.max[which(Sorted.45.90$RGroup=="p.cool.forb")]
PWF.max.45.90<-Sorted.45.90$Bmass.max[which(Sorted.45.90$RGroup=="p.warm.forb")]
PF.max.45.90<-PCF.max.45.90+PWF.max.45.90

PCF.mean.45.90<-Sorted.45.90$Bmass.mean[which(Sorted.45.90$RGroup=="p.cool.forb")]
PWF.mean.45.90<-Sorted.45.90$Bmass.mean[which(Sorted.45.90$RGroup=="p.warm.forb")]
PF.mean.45.90<-PCF.mean.45.90+PWF.mean.45.90

##### annual forbs
ACF.min.45.90<-Sorted.45.90$Bmass.min[which(Sorted.45.90$RGroup=="a.cool.forb")]
AWF.min.45.90<-Sorted.45.90$Bmass.min[which(Sorted.45.90$RGroup=="a.warm.forb")]
AF.min.45.90<-ACF.min.45.90+AWF.min.45.90

ACF.max.45.90<-Sorted.45.90$Bmass.max[which(Sorted.45.90$RGroup=="a.cool.forb")]
AWF.max.45.90<-Sorted.45.90$Bmass.max[which(Sorted.45.90$RGroup=="a.warm.forb")]
AF.max.45.90<-ACF.max.45.90+AWF.max.45.90

ACF.mean.45.90<-Sorted.45.90$Bmass.mean[which(Sorted.45.90$RGroup=="a.cool.forb")]
AWF.mean.45.90<-Sorted.45.90$Bmass.mean[which(Sorted.45.90$RGroup=="a.warm.forb")]
AF.mean.45.90<-ACF.mean.45.90+AWF.mean.45.90

################# Figures ##########################################
par(mar=c(4,4.5,4,1)+0.1)
plot(Sorted.45.90$Year[1:300],Sorted.45.90$Bmass.median[which(Sorted.45.90$RGroup=="sagebrush")],
     lwd=2,xlab="Year",ylim=c(0,940),xlim=c(0,300),ylab=expression("Biomass (g/m"^2*")"),
     type="l",cex.lab=1.2,cex.axis=1.2,col="white",bty="l",lab=c(12,5,7))
x=c(1:300,rev(1:300))
y1=c(Sorted.45.90$Bmass.min[which(Sorted.45.90$RGroup=="sagebrush")],
     rev(Sorted.45.90$Bmass.max[which(Sorted.45.90$RGroup=="sagebrush")]))

cols="gray60"

polygon(x,y1,col=alpha(cols,0.75),border=NA)

points(Sorted.45.90$Year[1:300],
       Sorted.45.90$Bmass.mean[which(Sorted.45.90$RGroup=="sagebrush")],lwd=2,type='l',col='black')
...
#        bty="n",ncol=2,cex=1)
par(xpd=NA)
text(45,1040, "d) Late-century: Sagebrush",cex=1.8)


#### Grasses ####
par(mar=c(4,4.5,4,1)+0.1)
plot(Sorted.45.90$Year[1:300],Sorted.45.90$Bmass.mean[which(Sorted.45.90$RGroup=="p.cool.grass")],lwd=2,xlab="Year",
     ylim=c(0,85),xlim=c(0,300),ylab=expression("Biomass (g/m"^2*")"),type="l",cex.lab=1.2,cex.axis=1.2,col="white",bty="l",lab=c(12,5,7))
x<-c(1:300,rev(1:300))
y2<-c(PCG.min.45.90,rev(PCG.max.45.90))
y3<-c(PWG.min.45.90,rev(PWG.max.45.90))
y4<-c(Sorted.45.90$Bmass.min[which(Sorted.45.90$RGroup=="a.cool.grass")],rev(Sorted.45.90$Bmass.max[which(Sorted.45.90$RGroup=="a.cool.grass")]))
cols2<-"palegreen"
...
points(Sorted.45.90$Year[1:300],PCG.mean.45.90,lwd=2,type='l',col='seagreen4')
points(Sorted.45.90$Year[1:300],PWG.mean.45.90,lwd=2,type='l',col='darkgoldenrod')
points(Sorted.45.90$Year[1:300],Sorted.45.90$Bmass.mean[which(Sorted.45.90$RGroup=="a.cool.grass")],lwd=2,type='l',col='mediumpurple4')
...
#        bty="n",ncol=3,cex=1)
par(xpd=NA)
text(45, 95, "e) Late-century: Grasses",cex=1.8)

#### Forbs ####
par(mar=c(4,4.5,4,1)+0.1)
plot(Sorted.45.90$Year[1:300],Sorted.45.90$Bmass.mean[which(Sorted.45.90$RGroup=="p.cool.forb")],lwd=2,xlab="Year",
     ylim=c(0,50),xlim=c(0,300),ylab=expression("Biomass (g/m"^2*")"),type="l",cex.lab=1.2,cex.axis=1.2,col="white",bty="l",lab=c(12,5,7))
x=c(1:300,rev(1:300))

y2=c(PF.min.45.90,rev(PF.max.45.90))
y3=c(AF.min.45.90,rev(AF.max.45.90))
y4=c(Sorted.45.90$Bmass.min[which(Sorted.45.90$RGroup=="shrub")],
     rev(Sorted.45.90$Bmass.max[which(Sorted.45.90$RGroup=="shrub")]))
...
points(Sorted.45.90$Year[1:300],PF.mean.45.90,lwd=2,type='l',col='darkred')
points(Sorted.45.90$Year[1:300],AF.mean.45.90,lwd=2,type='l',col='chocolate3')
points(Sorted.45.90$Year[1:300],
       Sorted.45.90$Bmass.mean[which(Sorted.45.90$RGroup=="shrub")],lwd=2,type='l',col='navyblue')
...
par(xpd=NA)
text(90,57, "f) Late-century: Forbs and other shrubs",cex=1.8)
################################################
