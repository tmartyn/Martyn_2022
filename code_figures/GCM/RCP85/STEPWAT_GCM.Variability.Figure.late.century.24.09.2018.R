...
############## 85.90 - DF and merging #############
Sorted.85.90<-Stepwat.Sorted[which(Stepwat.Sorted$Period=="d90yrs" & Stepwat.Sorted$RCP=="RCP85"),]
#Sorted.85.90$Bmass.median<-(Sorted.85.90$Bmass.med1+Sorted.85.90$Bmass.med2)/2

##### merge into larger groups
PCG.min.85.90<-Sorted.85.90$Bmass.min[which(Sorted.85.90$RGroup=="p.cool.grass")]
PWG.min.85.90<-Sorted.85.90$Bmass.min[which(Sorted.85.90$RGroup=="p.warm.grass")]
# PG.min.85.90<-PCG.min.85.90+PWG.min.85.90
# 
PCG.max.85.90<-Sorted.85.90$Bmass.max[which(Sorted.85.90$RGroup=="p.cool.grass")]
PWG.max.85.90<-Sorted.85.90$Bmass.max[which(Sorted.85.90$RGroup=="p.warm.grass")]
# PG.max.85.90<-PCG.max.85.90+PWG.max.85.90
# 
PCG.mean.85.90<-Sorted.85.90$Bmass.mean[which(Sorted.85.90$RGroup=="p.cool.grass")]
PWG.mean.85.90<-Sorted.85.90$Bmass.mean[which(Sorted.85.90$RGroup=="p.warm.grass")]
# PG.median.85.90<-PCG.median.85.90+PWG.median.85.90

##### perennial forbs
PCF.min.85.90<-Sorted.85.90$Bmass.min[which(Sorted.85.90$RGroup=="p.cool.forb")]
PWF.min.85.90<-Sorted.85.90$Bmass.min[which(Sorted.85.90$RGroup=="p.warm.forb")]
PF.min.85.90<-PCF.min.85.90+PWF.min.85.90

PCF.max.85.90<-Sorted.85.90$Bmass.max[which(Sorted.85.90$RGroup=="p.cool.forb")]
PWF.max.85.90<-Sorted.85.90$Bmass.max[which(Sorted.85.90$RGroup=="p.warm.forb")]
PF.max.85.90<-PCF.max.85.90+PWF.max.85.90

PCF.mean.85.90<-Sorted.85.90$Bmass.mean[which(Sorted.85.90$RGroup=="p.cool.forb")]
PWF.mean.85.90<-Sorted.85.90$Bmass.mean[which(Sorted.85.90$RGroup=="p.warm.forb")]
PF.mean.85.90<-PCF.mean.85.90+PWF.mean.85.90

##### annual forbs
ACF.min.85.90<-Sorted.85.90$Bmass.min[which(Sorted.85.90$RGroup=="a.cool.forb")]
AWF.min.85.90<-Sorted.85.90$Bmass.min[which(Sorted.85.90$RGroup=="a.warm.forb")]
AF.min.85.90<-ACF.min.85.90+AWF.min.85.90

ACF.max.85.90<-Sorted.85.90$Bmass.max[which(Sorted.85.90$RGroup=="a.cool.forb")]
AWF.max.85.90<-Sorted.85.90$Bmass.max[which(Sorted.85.90$RGroup=="a.warm.forb")]
AF.max.85.90<-ACF.max.85.90+AWF.max.85.90

ACF.mean.85.90<-Sorted.85.90$Bmass.mean[which(Sorted.85.90$RGroup=="a.cool.forb")]
AWF.mean.85.90<-Sorted.85.90$Bmass.mean[which(Sorted.85.90$RGroup=="a.warm.forb")]
AF.mean.85.90<-ACF.mean.85.90+AWF.mean.85.90

################# Figures ##########################################
######### shrubs ##################
par(mar=c(4,4.5,4,1)+0.1)
plot(Sorted.85.90$Year[1:300],Sorted.85.90$Bmass.mean[which(Sorted.85.90$RGroup=="sagebrush")],
...
x=c(1:300,rev(1:300))
y1=c(Sorted.85.90$Bmass.min[which(Sorted.85.90$RGroup=="sagebrush")],
     rev(Sorted.85.90$Bmass.max[which(Sorted.85.90$RGroup=="sagebrush")]))

cols="gray60"

polygon(x,y1,col=alpha(cols,0.75),border=NA)

points(Sorted.85.90$Year[1:300],
       Sorted.85.90$Bmass.mean[which(Sorted.85.90$RGroup=="sagebrush")],lwd=2,type='l',col='black')
...
#### Grasses ####
par(mar=c(4,4.5,4,1)+0.1)
plot(Sorted.85.90$Year[1:300],Sorted.85.90$Bmass.mean[which(Sorted.85.90$RGroup=="p.cool.grass")],lwd=2,xlab="Year",
     ylim=c(0,85),xlim=c(0,300),ylab=expression("Biomass (g/m"^2*")"),type="l",cex.lab=1.2,cex.axis=1.2,col="white",bty="l",lab=c(12,5,7))
x<-c(1:300,rev(1:300))
y2<-c(PCG.min.85.90,rev(PCG.max.85.90))
y3<-c(PWG.min.85.90,rev(PWG.max.85.90))
y4<-c(Sorted.85.90$Bmass.min[which(Sorted.85.90$RGroup=="a.cool.grass")],rev(Sorted.85.90$Bmass.max[which(Sorted.85.90$RGroup=="a.cool.grass")]))
cols2<-"palegreen"
...
points(Sorted.85.90$Year[1:300],PCG.mean.85.90,lwd=2,type='l',col='seagreen4')
points(Sorted.85.90$Year[1:300],PWG.mean.85.90,lwd=2,type='l',col='darkgoldenrod')
points(Sorted.85.90$Year[1:300],Sorted.85.90$Bmass.mean[which(Sorted.85.90$RGroup=="a.cool.grass")],lwd=2,type='l',col='mediumpurple4')
...
#### Forbs ####
par(mar=c(4,4.5,4,1)+0.1)
plot(Sorted.85.90$Year[1:300],Sorted.85.90$Bmass.mean[which(Sorted.85.90$RGroup=="p.cool.forb")],lwd=2,xlab="Year",
     ylim=c(0,50),xlim=c(0,300),ylab=expression("Biomass (g/m"^2*")"),type="l",cex.lab=1.2,cex.axis=1.2,col="white",bty="l",lab=c(12,5,7))
x=c(1:300,rev(1:300))

y2=c(PF.min.85.90,rev(PF.max.85.90))
y3=c(AF.min.85.90,rev(AF.max.85.90))
y4<-c(Sorted.85.90$Bmass.min[which(Sorted.85.90$RGroup=="shrub")],
      rev(Sorted.85.90$Bmass.max[which(Sorted.85.90$RGroup=="shrub")]))
...
points(Sorted.85.90$Year[1:300],PF.mean.85.90,lwd=2,type='l',col='darkred')
points(Sorted.85.90$Year[1:300],AF.mean.85.90,lwd=2,type='l',col='chocolate3')
points(Sorted.85.90$Year[1:300],
       Sorted.85.90$Bmass.mean[which(Sorted.85.90$RGroup=="shrub")],lwd=2,type='l',col='navyblue')
