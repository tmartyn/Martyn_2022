...
names(Stepwat.Sorted)[15]<-"Bmass.mean"
...
################ Make figure ##########################################
pdf(height=9, width=13, "figures/GCM_Bmass_RCP85.pdf",useDingbats=F)
#par(mar=c(4,4.5,4,5)+0.1)
par(mfrow=c(2,3), oma = c(5,4,0,0) + 0.1,
    mar = c(0,0,1,1) + 0.1)

source("code_figures/RCP85/STEPWAT_GCM.Variability.Figure.mid.century.24.09.2018.R")

source("code_figures/RCP85/STEPWAT_GCM.Variability.Figure.late.century.24.09.2018.R")
