...
Sorted.85.50<-Stepwat.Sorted[which(Stepwat.Sorted$Period=="d50yrs" & Stepwat.Sorted$RCP=="RCP85"),]
...
plot(Sorted.85.50$Year[1:300],Sorted.85.50$Bmass.median[which(Sorted.85.50$RGroup=="sagebrush")],
...
x=c(1:300,rev(1:300))
y1=c(Sorted.85.50$Bmass.min[which(Sorted.85.50$RGroup=="sagebrush")],
...
points(Sorted.85.50$Year[1:300],
       Sorted.85.50$Bmass.mean[which(Sorted.85.50$RGroup=="sagebrush")],lwd=2,type='l',col='black')
...
#### Grasses ####
par(mar=c(4,4.5,4,1)+0.1)
plot(Sorted.85.50$Year[1:300],Sorted.85.50$Bmass.mean[which(Sorted.85.50$RGroup=="p.cool.grass")],lwd=2,xlab="",
...
y4<-c(Sorted.85.50$Bmass.min[which(Sorted.85.50$RGroup=="a.cool.grass")],rev(Sorted.85.50$Bmass.max[which(Sorted.85.50$RGroup=="a.cool.grass")]))
cols2<-"palegreen"
...
points(Sorted.85.50$Year[1:300],PCG.mean.85.50,lwd=2,type='l',col='seagreen4')
points(Sorted.85.50$Year[1:300],PWG.mean.85.50,lwd=2,type='l',col='darkgoldenrod')
...
#### Forbs ####
par(mar=c(4,4.5,4,1)+0.1)
plot(Sorted.85.50$Year[1:300],Sorted.85.50$Bmass.mean[which(Sorted.85.50$RGroup=="p.cool.forb")],lwd=2,xlab="",
...
y4<-c(Sorted.85.50$Bmass.min[which(Sorted.85.50$RGroup=="shrub")],
...
points(Sorted.85.50$Year[1:300],
       Sorted.85.50$Bmass.mean[which(Sorted.85.50$RGroup=="shrub")],lwd=2,type='l',col='navyblue')
